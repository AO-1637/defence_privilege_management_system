...
<head>
  <meta charset="UTF-8">
  <title>Defence Privileges Management System</title>
...
<body background="images\pic10.jpg">
  <header>
    <?php
        include("server.php");
         if($_SESSION["count"] != 1)
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <form action="server.php" method="post">
            <div>
              <input type="hidden" name="eval" value="signup">
            </div>
        ...
        <div id="login">   
          ...
          <form action="server.php" method="post">
            <div>
            <input type="hidden" name="eval" value="login">
          </div>
            <div class="field-wrap">
            <label>
              Email Address<span class="req">*</span>
